# Debian and its derivatives, running the native client

Oh, so you chose the hard way. Good luck! Given it's 2025, we assume you are using the 64bit client
...
Install the `cor-debian-packages` meta package at [https://codeberg.org/mascal/cor-debian-packages](https://codeberg.org/mascal/cor-debian-packages) (you'll find instructions there as well)
